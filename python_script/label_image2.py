...
refPt = []
cropping = False
label_name = "D:/Electron/taidum_classification_app/python_script/model/taidum_labels(clean_1).txt"
model_name = "D:/Electron/taidum_classification_app/python_script/model/taidam_graph(clean_1).pb"
...
def predic_taidum(image_name):
  ...
  #3 = run of prediction
  run_graph(image_data, labels,'DecodeJpeg/contents:0' ,'final_result:0',3)
